    ...
    <nav>
        <div class="menu_wrapper">
            ...
            <div class="menu_controls">
                <v-btn class="menu_item" flat round :to="{ name: 'movies' }" > Movies </v-btn>
                <v-btn class="menu_item" flat round  :to="{ name: 'shows' }" > TV Shows </v-btn>
                <v-btn class="menu_item" flat round  :to="{ name: 'celebrities' }" > Celebrities </v-btn>
